...
import 'package:business_apk/view/widgets/one_screen.dart';
...
class Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //auto state 2.5 seconds
    Future.delayed(const Duration(milliseconds: 2500), () {
      if (autoController.isFirstTime) {
        Get.off(() => const OneScreen());
      } else if (autoController.isLoggedIn) {
...
class GridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    const spacing = 20.0; // Distance between lines
